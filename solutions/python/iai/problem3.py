...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 19 11:22:04 2024
...
def execute():
	...
	# Renvoie la somme maximale en considérant la sous-matrice depuis la ligne 'startrow' jusqu'au bas,
    # avec le jeu de bits 'setofcols' indiquant quels index de colonnes sont encore libres d'être utilisés.
	def find_maximum_sum(startrow, setofcols):
		if startrow == ROWS:
			assert hacklib2.popcount(setofcols) == COLUMNS - ROWS
			return 0
